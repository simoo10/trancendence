...
function ControlPaddle(ev) { // called on mouse move while button is down
    var e = ev || window.event;
    ...
    if (e.pageX || e.pageY) {
        ...
        posY = e.clientY + document.body.scrollTop + document.documentElement.scrollTop - page.offsetTop;
    }
    if (posY > -1) {
        if (controllingPaddle == 1) {
